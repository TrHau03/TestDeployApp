...
export default function SignInForm() {
    ...
    const { trigger } = useSWRMutation<unknown, Error, string, LoginRequest>(
        APIEndpoint.SIGNIN,
        (_, { arg }) => {
            console.log("arg", arg)
        ...
        },
        {
            onSuccess: async () => {
                triggerAuth()
                console.log("success")
                router.push(AppEndpoint.DASHBOARD)
            },
            onError: async (error) => {
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="form-input placeholder:text-white-dark py-3 ps-10"
                                        {...register("email")}
                                    />
                                </div>
                                <div>
