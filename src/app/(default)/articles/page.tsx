...
function ArticlesPage() {
    ...
    // const articles = useAppSelector((state) => state.articles) // list Articles
                    ...
                    <div className="h-[calc(100%-64px)] overflow-y-auto px-4 py-4 md:h-[calc(100vh-64px)] md:px-6">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-2 flex flex-wrap gap-2">
                                {["AI", "DeFi", "Layer-1", "Gaming"].map(
                                    (tag) => (
                                        <button
                                            key={tag}
                                            className="rounded-md border border-gray-600 px-3 py-1 text-xs"
                                        >
                                            {tag}
                                        </button>
                                    ),
                        ...
                        <div className="overflow-x-auto rounded-lg border border-gray-700">
                            ...
                            <div className="min-w-full">
                                <div className="grid grid-cols-12 border-b border-gray-700 bg-gray-800">
                                    <div className="col-span-5 p-4 text-sm font-semibold text-white">
                                        Article
                                    </div>
                                    <div className="col-span-2 p-4 text-sm font-semibold text-white">
                                        Date
                                    </div>
                                    <div className="col-span-2 p-4 text-sm font-semibold text-white">
                                        Category
                                ...
                                {articles.map((article: any) => (
                                    ...
                                    >
                                        <div className="grid grid-cols-12 items-center border-b border-gray-700 bg-gray-800">
                                            ...
                                            <div className="col-span-2 p-4 text-sm text-gray-400">
                                                {article.updated_at || "N/A"}
                                            </div>
                                            <div className="col-span-2 p-4 text-sm text-gray-400">
                                                {"Uncategorized"}
                                            </div>
