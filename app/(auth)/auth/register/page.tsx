...
const RegisterPage = () => {
  return (
    ...
    //           <div className="mb-10">
    //             <h1 className="text-3xl font-extrabold !leading-snug text-primary md:text-4xl">Sign Up</h1>
    ...
    //               style={{ width: '40%' }}
    //             ></span>
    //             <span className="relative px-2 font-bold uppercase text-white-dark dark:text-white-light">OR</span>
    //             <span
