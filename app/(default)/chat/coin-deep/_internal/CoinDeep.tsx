        ...
        <div className="flex flex-col md:grid md:grid-cols-10 gap-5 min-h-[calc(100vh_-_6rem)] md:min-h-[calc(100vh_-_8rem)] overflow-hidden">
            ...
            <div className="panel relative z-10 col-span-2 flex h-full flex-col space-y-4 overflow-hidden border-[0.5px] border-primary/30 p-4">
                <select
                    ...
                    onChange={(e) =>
                        setSelectedPeriod(
                            e.target.value as typeof selectedPeriod,
                        )
                    }
                    className="w-full rounded-md border border-white-light bg-white px-2 py-2 text-sm font-semibold text-black !outline-none focus:ring-transparent dark:border-[#17263c] dark:bg-[#121e32] dark:text-white-dark"
                    style={{}}
                >
                    {[
                        "1m",
                    ...
                    {coinMock.map((item) => {
                        return (
                            <CoinItem
                                key={item.id}
                                {...item}
                                isActive={selectedChatID === item.name}
                                onSelect={(name) => setSelectedChatID(name)}
                            />
                        )
                    })}
                </ul>
            ...
            <div
                className={`panel flex-grow md:col-span-6 ${
                    html === "" && "border-[0.5px]"
...
const coinMock = [
    {
        id: "1",
        name: "Bitcoin",
        logo: require("@/public/assets/images/bitcoin.png"),
    },
    {
        id: "2",
        name: "Ethereum",
        logo: require("@/public/assets/images/ethereum.png"),
    },
    {
        id: "3",
        name: "Chain Link",
        logo: require("@/public/assets/images/chainlink.png"),
    },
]
