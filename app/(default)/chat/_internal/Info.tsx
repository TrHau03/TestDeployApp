    ...
    <div className="col-span-2 overflow-hidden rounded-lg shadow-lg">
      <div className="p-4">
        ...
        <div className="mt-2 flex items-center">
          ...
          <span className="ml-2 truncate text-xs text-gray-400">#{profile.slug}</span>
        </div>

        <div className="mt-4">
          <h3 className="text-xs font-semibold uppercase text-gray-400">Description</h3>
          <p className="mt-1 text-sm text-gray-300">{profile.description}</p>
        </div>
      </div>
    </div>
  );
